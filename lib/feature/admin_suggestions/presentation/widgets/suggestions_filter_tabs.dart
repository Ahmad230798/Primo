...
class SuggestionsFilterTabs extends StatelessWidget {
  const SuggestionsFilterTabs({super.key});

  @override
  Widget build(BuildContext context) {
    // التبويبات حسب التصميم
    final tabs = [
      {"title": "الجديدة (4)", "isActive": true},
      {"title": "قيد المراجعة", "isActive": false},
      {"title": "تم التوفير", "isActive": false},
    ];
