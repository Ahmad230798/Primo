              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // الخط الفاصل
                    Divider(
                      color: AppColors.formBorder.withOpacity(0.6),
                      height: 1,
                    ),
                    8.verticalSpace,
                    ...
                    Row(
                      children: [
                        // 💡 التعديل 1: تغليف زر التعديل بـ Expanded
                        Expanded(
                          child: InkWell(
                            onTap: onEdit,
                            ...
                            child: Container(
                              padding: EdgeInsets.symmetric(
                                vertical: 6.h,
                              ), // تقليل الـ padding العرضي
                              decoration: BoxDecoration(
                                color: AppColors.greyBackground,
                                borderRadius: BorderRadius.circular(8.r),
                              ),
                              // 💡 التعديل 2: إضافة FittedBox لمنع تجاوز النص داخل الزر
                              child: FittedBox(
                        ...
                        // 💡 التعديل 3: تغليف زر الحذف بـ Expanded
                        Expanded(
                          child: InkWell(
                            onTap: onDelete,
                            borderRadius: BorderRadius.circular(8.r),
